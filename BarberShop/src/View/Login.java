...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelLoginFundo.setMaximumSize(new java.awt.Dimension(813, 120));
        LabelLoginFundo.setPreferredSize(new java.awt.Dimension(813, 800));
        getContentPane().add(LabelLoginFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -2, -1, 1020));
